                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-2 mb-2">
                            <img src="<?= base_url() ?>assets/upload/barang/<?= $bm->foto ?>" alt="" width="100%"
                                style="border-radius: 5px;">
                        </div>
                        <div class="col-lg-10">
                            <h5 class="h5 mb-0 text-gray-800"><b><?= $bm->nama_barang ?></b></h5>
                            <h6 class="h6 mb-0 text-gray-800"><?= $bm->tgl_masuk ?></h6>
                            <span class="badge badge-success"> <i class="fa fa-plus"></i>
                                <?= $bm->jumlah_masuk ?></span>
                        </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-2 mb-2">
                            <img src="<?= base_url() ?>assets/upload/barang/<?= $bk->foto ?>" alt="" width="100%"
                                style="border-radius: 5px;">
                        </div>
                        <div class="col-lg-10">
                            <h5 class="h5 mb-0 text-gray-800"><b><?= $bk->nama_barang ?></b></h5>
                            <h6 class="h6 mb-0 text-gray-800"><?= $bk->tgl_keluar ?></h6>
                            <span class="badge badge-danger"> <i class="fa fa-minus"></i>
                                <?= $bk->jumlah_keluar ?></span>
                        </div>
