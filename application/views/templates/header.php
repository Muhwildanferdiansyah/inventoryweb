...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- UNTUK EOQ -->
            <!-- <?php if($this->session->userdata('login_session')['level'] == 'gudang'): ?> -->
            ...
            <?php if($title == 'Safetystok'): ?>
            <li class="nav-item active">
                <?php else: ?>
            <li class="nav-item">
                <?php endif; ?>
                <a class="nav-link" href="<?= base_url() ?>safetystok">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Safety stok</span>
                </a>
            </li>

            <?php if($title == 'Reorderpoint'): ?>
            <li class="nav-item active">
                <?php else: ?>
            <li class="nav-item">
                <?php endif; ?>
                <a class="nav-link" href="<?= base_url() ?>rop">
                    <i class="fas fa-fw fa-users"></i>
