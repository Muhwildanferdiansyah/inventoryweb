...
class Safetystok extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('safetystok/index');
	...
	public function tambah()
	{
		...
		$this->load->view('templates/header', $data);
		$this->load->view('safetystok/form_tambah');
		$this->load->view('templates/footer');
	}
	...
	public function ubah($id)
	{
		...
		$this->load->view('templates/header', $data);
		$this->load->view('safetystok/form_ubah');
		$this->load->view('templates/footer');
	}
